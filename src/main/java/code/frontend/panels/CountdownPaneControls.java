 ...
 * When there is 1 {@link CountdownPane} selected, only the deselect, edit and remove buttons are shown.
 * When there is greater than 1 {@link CountdownPane} selected, only the deselect and remove buttons are shown.
 *
