...
public class OldCountdownTable extends ScrollPane {
    ...
    private static OldCountdownTable cpv = null;

    private OldCountdownTable() {
    ...
    @Deprecated
    public static OldCountdownTable getInstance() {
        if (cpv == null) {
            cpv = new OldCountdownTable();
