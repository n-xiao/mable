...
import code.frontend.libs.katlaf.lists.DraggableList;
import javafx.scene.layout.VBox;

public class FolderList extends VBox {
    private final SearchField searchField;
    private final DraggableList<CountdownFolder> list;
    ...
    private class List extends DraggableList<CountdownFolder> {
        public List() {
            super(FolderHandler.getFolders());
        }
    }
}
